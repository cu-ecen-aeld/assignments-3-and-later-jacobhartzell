...
void test_validate_my_username()
{
   ...
   const char *my_username_ptr = my_username();
   char *username_from_conf_ptr = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username_ptr, username_from_conf_ptr, "OK");
}
